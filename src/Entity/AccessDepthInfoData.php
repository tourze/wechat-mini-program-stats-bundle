...
#[AsPermission(title: '获取用户小程序访问分布数据(访问深度的分布)')]
#[Listable]
#[Creatable]
#[ORM\Entity(repositoryClass: AccessDepthInfoDataRepository::class)]
#[ORM\Table(name: 'wechat_access_depth_info_data', options: ['comment' => '获取用户小程序访问分布数据(访问深度的分布)'])]
#[ORM\UniqueConstraint(name: 'wechat_access_depth_info_data_uniq', columns: ['date', 'account_id', 'data_key'])]
class AccessDepthInfoData implements AdminArrayInterface
{
    #[ExportColumn]
