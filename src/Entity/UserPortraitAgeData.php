...
class UserPortraitAgeData implements AdminArrayInterface, UserPortraitEntityInterface, \Stringable
{
    ...
    #[ORM\Column(type: Types::STRING, length: 255, nullable: true, options: ['comment' => '值ID'])]
    #[Assert\Length(max: 255)]
