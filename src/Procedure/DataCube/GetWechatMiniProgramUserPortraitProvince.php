...
class GetWechatMiniProgramUserPortraitProvince extends CacheableProcedure
{
    ...
    /**
     * @phpstan-param GetWechatMiniProgramUserPortraitProvinceParam $param
     */
    public function execute(GetWechatMiniProgramUserPortraitProvinceParam|RpcParamInterface $param): ArrayResult
    {
