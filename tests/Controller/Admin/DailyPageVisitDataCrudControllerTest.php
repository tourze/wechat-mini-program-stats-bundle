...
/**
 * DailyPageVisitDataCrudController 测试
 *
 * @internal
 */
#[CoversClass(DailyPageVisitDataCrudController::class)]
#[RunTestsInSeparateProcesses]
final class DailyPageVisitDataCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /**
     * 获取控制器服务实例
     */
    protected function getControllerService(): DailyPageVisitDataCrudController
    {
        return self::getService(DailyPageVisitDataCrudController::class);
    }
    ...
    {
        // 验证实体类名获取
        $this->assertSame(DailyPageVisitData::class, DailyPageVisitDataCrudController::getEntityFqcn());
    }
