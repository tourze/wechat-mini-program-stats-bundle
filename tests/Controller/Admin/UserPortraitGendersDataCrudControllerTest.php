...
/**
 * UserPortraitGendersDataCrudController 测试
 *
 * @internal
 */
#[CoversClass(UserPortraitGendersDataCrudController::class)]
#[RunTestsInSeparateProcesses]
final class UserPortraitGendersDataCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    protected function getControllerService(): UserPortraitGendersDataCrudController
    {
        return self::getService(UserPortraitGendersDataCrudController::class);
    }
    ...
    {
        $this->assertSame(UserPortraitGendersData::class, UserPortraitGendersDataCrudController::getEntityFqcn());
    }
