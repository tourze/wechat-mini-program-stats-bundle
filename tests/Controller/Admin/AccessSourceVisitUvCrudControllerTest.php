...
/**
 * AccessSourceVisitUvCrudController 测试
 *
 * @internal
 */
#[CoversClass(AccessSourceVisitUvCrudController::class)]
#[RunTestsInSeparateProcesses]
final class AccessSourceVisitUvCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /**
     * 获取控制器服务实例
     */
    protected function getControllerService(): AccessSourceVisitUvCrudController
    {
        return self::getService(AccessSourceVisitUvCrudController::class);
    }
    ...
    {
        // 验证实体类名获取
        $this->assertSame(AccessSourceVisitUv::class, AccessSourceVisitUvCrudController::getEntityFqcn());
    }
