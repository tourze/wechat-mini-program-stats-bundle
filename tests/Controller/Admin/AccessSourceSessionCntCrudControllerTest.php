...
/**
 * AccessSourceSessionCntCrudController 测试
 *
 * @internal
 */
#[CoversClass(AccessSourceSessionCntCrudController::class)]
#[RunTestsInSeparateProcesses]
final class AccessSourceSessionCntCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /**
     * 获取控制器服务实例
     */
    protected function getControllerService(): AccessSourceSessionCntCrudController
    {
        return self::getService(AccessSourceSessionCntCrudController::class);
    }
    ...
    {
        // 验证实体类名获取
        $this->assertSame(AccessSourceSessionCnt::class, AccessSourceSessionCntCrudController::getEntityFqcn());
    }
