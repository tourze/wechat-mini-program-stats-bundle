...
/**
 * AccessDepthInfoDataCrudController 测试
 *
 * @internal
 */
#[CoversClass(AccessDepthInfoDataCrudController::class)]
#[RunTestsInSeparateProcesses]
final class AccessDepthInfoDataCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /**
     * 获取控制器服务实例
     */
    protected function getControllerService(): AccessDepthInfoDataCrudController
    {
        return self::getService(AccessDepthInfoDataCrudController::class);
    }
    ...
    {
        // 验证实体类名获取
        $this->assertSame(AccessDepthInfoData::class, AccessDepthInfoDataCrudController::getEntityFqcn());
    }
