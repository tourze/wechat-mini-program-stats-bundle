...
/**
 * UserPortraitProvinceDataCrudController 测试
 *
 * @internal
 */
#[CoversClass(UserPortraitProvinceDataCrudController::class)]
#[RunTestsInSeparateProcesses]
final class UserPortraitProvinceDataCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    protected function getControllerService(): UserPortraitProvinceDataCrudController
    {
        return self::getService(UserPortraitProvinceDataCrudController::class);
    }
    ...
    {
        $this->assertSame(UserPortraitProvinceData::class, UserPortraitProvinceDataCrudController::getEntityFqcn());
    }
