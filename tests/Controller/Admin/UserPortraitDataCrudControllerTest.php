...
/**
 * UserPortraitDataCrudController 测试
 *
 * @internal
 */
#[CoversClass(UserPortraitDataCrudController::class)]
#[RunTestsInSeparateProcesses]
final class UserPortraitDataCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    protected function getControllerService(): UserPortraitDataCrudController
    {
        return self::getService(UserPortraitDataCrudController::class);
    }
    ...
    {
        $this->assertSame(UserPortraitData::class, UserPortraitDataCrudController::getEntityFqcn());
    }
