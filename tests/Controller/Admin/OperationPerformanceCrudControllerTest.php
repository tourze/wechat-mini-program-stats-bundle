...
/**
 * OperationPerformanceCrudController 测试
 *
 * @internal
 */
#[CoversClass(OperationPerformanceCrudController::class)]
#[RunTestsInSeparateProcesses]
final class OperationPerformanceCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    protected function getControllerService(): OperationPerformanceCrudController
    {
        return self::getService(OperationPerformanceCrudController::class);
    }
    ...
    {
        $this->assertSame(OperationPerformance::class, OperationPerformanceCrudController::getEntityFqcn());
    }
