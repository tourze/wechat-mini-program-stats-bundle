...
/**
 * UserAccessesMonthDataCrudController 测试
 *
 * @internal
 */
#[CoversClass(UserAccessesMonthDataCrudController::class)]
#[RunTestsInSeparateProcesses]
final class UserAccessesMonthDataCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /**
     * 获取控制器服务实例
     */
    protected function getControllerService(): UserAccessesMonthDataCrudController
    {
        return self::getService(UserAccessesMonthDataCrudController::class);
    }
    ...
    {
        // 验证实体类名获取
        $this->assertSame(UserAccessesMonthData::class, UserAccessesMonthDataCrudController::getEntityFqcn());
    }
