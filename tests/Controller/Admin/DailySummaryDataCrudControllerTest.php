...
/**
 * DailySummaryDataCrudController 测试
 *
 * @internal
 */
#[CoversClass(DailySummaryDataCrudController::class)]
#[RunTestsInSeparateProcesses]
final class DailySummaryDataCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /**
     * 获取控制器服务实例
     */
    protected function getControllerService(): DailySummaryDataCrudController
    {
        return self::getService(DailySummaryDataCrudController::class);
    }
    ...
    {
        // 验证实体类名获取
        $this->assertSame(DailySummaryData::class, DailySummaryDataCrudController::getEntityFqcn());
    }
