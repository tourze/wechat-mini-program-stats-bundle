...
/**
 * MonthlyVisitTrendCrudController 测试
 *
 * @internal
 */
#[CoversClass(MonthlyVisitTrendCrudController::class)]
#[RunTestsInSeparateProcesses]
final class MonthlyVisitTrendCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /**
     * 获取控制器服务实例
     */
    protected function getControllerService(): MonthlyVisitTrendCrudController
    {
        return self::getService(MonthlyVisitTrendCrudController::class);
    }
    ...
    {
        // 验证实体类名获取
        $this->assertSame(MonthlyVisitTrend::class, MonthlyVisitTrendCrudController::getEntityFqcn());
    }
