...
/**
 * PerformanceDataCrudController 测试
 *
 * @internal
 */
#[CoversClass(PerformanceDataCrudController::class)]
#[RunTestsInSeparateProcesses]
final class PerformanceDataCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /**
     * 获取控制器服务实例
     */
    protected function getControllerService(): PerformanceDataCrudController
    {
        return self::getService(PerformanceDataCrudController::class);
    }
    ...
    {
        // 验证实体类名获取
        $this->assertSame(PerformanceData::class, PerformanceDataCrudController::getEntityFqcn());
    }
