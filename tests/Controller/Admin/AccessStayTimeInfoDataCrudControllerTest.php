...
/**
 * AccessStayTimeInfoDataCrudController 测试
 *
 * @internal
 */
#[CoversClass(AccessStayTimeInfoDataCrudController::class)]
#[RunTestsInSeparateProcesses]
final class AccessStayTimeInfoDataCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /**
     * 获取控制器服务实例
     */
    protected function getControllerService(): AccessStayTimeInfoDataCrudController
    {
        return self::getService(AccessStayTimeInfoDataCrudController::class);
    }
    ...
    {
        // 验证实体类名获取
        $this->assertSame(AccessStayTimeInfoData::class, AccessStayTimeInfoDataCrudController::getEntityFqcn());
    }
