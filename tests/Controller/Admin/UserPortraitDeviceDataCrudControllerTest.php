...
/**
 * UserPortraitDeviceDataCrudController 测试
 *
 * @internal
 */
#[CoversClass(UserPortraitDeviceDataCrudController::class)]
#[RunTestsInSeparateProcesses]
final class UserPortraitDeviceDataCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    protected function getControllerService(): UserPortraitDeviceDataCrudController
    {
        return self::getService(UserPortraitDeviceDataCrudController::class);
    }
    ...
    {
        $this->assertSame(UserPortraitDeviceData::class, UserPortraitDeviceDataCrudController::getEntityFqcn());
    }
