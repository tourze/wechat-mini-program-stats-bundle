...
/**
 * DailyVisitTrendDataCrudController 测试
 *
 * @internal
 */
#[CoversClass(DailyVisitTrendDataCrudController::class)]
#[RunTestsInSeparateProcesses]
final class DailyVisitTrendDataCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    /**
     * 获取控制器服务实例
     */
    protected function getControllerService(): DailyVisitTrendDataCrudController
    {
        return self::getService(DailyVisitTrendDataCrudController::class);
    }
    ...
    {
        // 验证实体类名获取
        $this->assertSame(DailyVisitTrendData::class, DailyVisitTrendDataCrudController::getEntityFqcn());
    }
