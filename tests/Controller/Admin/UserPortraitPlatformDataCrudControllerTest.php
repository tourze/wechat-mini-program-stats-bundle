...
/**
 * UserPortraitPlatformDataCrudController 测试
 *
 * @internal
 */
#[CoversClass(UserPortraitPlatformDataCrudController::class)]
#[RunTestsInSeparateProcesses]
final class UserPortraitPlatformDataCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    protected function getControllerService(): UserPortraitPlatformDataCrudController
    {
        return self::getService(UserPortraitPlatformDataCrudController::class);
    }
    ...
    {
        $this->assertSame(UserPortraitPlatformData::class, UserPortraitPlatformDataCrudController::getEntityFqcn());
    }
