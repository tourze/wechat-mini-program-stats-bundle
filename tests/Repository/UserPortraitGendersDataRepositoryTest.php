 ...
 * @internal
 */
#[CoversClass(UserPortraitGendersDataRepository::class)]
#[RunTestsInSeparateProcesses]
final class UserPortraitGendersDataRepositoryTest extends AbstractRepositoryTestCase
{
    private UserPortraitGendersDataRepository $repository;

    private UserPortraitGendersData $entity;

    protected function onSetUp(): void
    {
        $this->repository = self::getService(UserPortraitGendersDataRepository::class);
        $this->entity = $this->createTestEntity();
    }

    public function testClassExists(): void
    {
        self::assertTrue(class_exists(UserPortraitGendersDataRepository::class));
    }
    ...
    public function testSaveMethodShouldPersistEntity(): void
    {
        ...
        self::assertInstanceOf(UserPortraitGendersData::class, $savedEntity);
    ...
    private function createTestEntity(): UserPortraitGendersData
    {
        $entity = new UserPortraitGendersData();
    ...
    public function testFindOneByWithSorting(): void
    {
        ...
        self::assertInstanceOf(UserPortraitGendersData::class, $resultDesc);
    }
    ...
    public function testFindByWithNullDate(): void
    {
        self::getEntityManager()->getConnection()->executeStatement(
            'DELETE FROM wechat_user_access_portrait_genders_data'
        );
    ...
    protected function createNewEntity(): object
    {
        ...
        $entity->setDate('2024-01-15-' . uniqid());
        $entity->setType('test-type-' . uniqid());
        $entity->setName('Test UserPortraitGendersDataRepository ' . uniqid());
        $entity->setValue('test-value');
        $entity->setValueId('test-value-id');
    ...
    /**
     * @return UserPortraitGendersDataRepository
     */
    protected function getRepository(): UserPortraitGendersDataRepository
    {
