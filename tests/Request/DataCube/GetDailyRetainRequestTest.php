 ...
 * @internal
 */
#[CoversClass(GetDailyRetainRequest::class)]
final class GetDailyRetainRequestTest extends RequestTestCase
{
    ...
    {
        self::assertSame('/datacube/getweanalysisappiddailyretaininfo', $this->request->getRequestPath());
    }
    ...
    {
        $beginDate = CarbonImmutable::createFromFormat('Y-m-d', '2023-12-25') ?? CarbonImmutable::now();
        $endDate = CarbonImmutable::createFromFormat('Y-m-d', '2023-12-31') ?? CarbonImmutable::now();
