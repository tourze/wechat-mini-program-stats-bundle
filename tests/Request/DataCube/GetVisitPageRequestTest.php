 ...
 * @internal
 */
#[CoversClass(GetVisitPageRequest::class)]
final class GetVisitPageRequestTest extends RequestTestCase
{
    private GetVisitPageRequest $request;

    protected function setUp(): void
    {
        $this->request = new GetVisitPageRequest();
    }

    public function testGetRequestPath(): void
    {
        self::assertSame('/datacube/getweanalysisappidvisitpage', $this->request->getRequestPath());
    }
