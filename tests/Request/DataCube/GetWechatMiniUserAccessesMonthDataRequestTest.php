 ...
 * @internal
 */
#[CoversClass(GetWechatMiniUserAccessesMonthDataRequest::class)]
final class GetWechatMiniUserAccessesMonthDataRequestTest extends RequestTestCase
{
    private GetWechatMiniUserAccessesMonthDataRequest $request;

    protected function setUp(): void
    {
        $this->request = new GetWechatMiniUserAccessesMonthDataRequest();
    }

    public function testGetRequestPath(): void
    {
        self::assertSame('/datacube/getweanalysisappidmonthlyretaininfo', $this->request->getRequestPath());
    }
