 ...
 * @internal
 */
#[CoversClass(GetMonthlyVisitTrendRequest::class)]
final class GetMonthlyVisitTrendRequestTest extends RequestTestCase
{
    ...
    {
        self::assertSame('/datacube/getweanalysisappidmonthlyvisittrend', $this->request->getRequestPath());
    }
