 ...
 * @internal
 */
#[CoversClass(GetDailyVisitTrendRequest::class)]
final class GetDailyVisitTrendRequestTest extends RequestTestCase
{
    private GetDailyVisitTrendRequest $request;

    protected function setUp(): void
    {
        $this->request = new GetDailyVisitTrendRequest();
    }

    public function testGetRequestPath(): void
    {
        self::assertSame('/datacube/getweanalysisappiddailyvisittrend', $this->request->getRequestPath());
    }
