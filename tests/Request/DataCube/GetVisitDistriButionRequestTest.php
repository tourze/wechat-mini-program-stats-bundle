 ...
 * @internal
 */
#[CoversClass(GetVisitDistriButionRequest::class)]
final class GetVisitDistriButionRequestTest extends RequestTestCase
{
    ...
    {
        self::assertSame('/datacube/getweanalysisappidvisitdistribution', $this->request->getRequestPath());
    }
