 ...
 * @internal
 */
#[CoversClass(GetDailySummaryRequest::class)]
final class GetDailySummaryRequestTest extends RequestTestCase
{
    private GetDailySummaryRequest $request;

    protected function setUp(): void
    {
        $this->request = new GetDailySummaryRequest();
    }

    public function testGetRequestPath(): void
    {
        self::assertSame('/datacube/getweanalysisappiddailysummarytrend', $this->request->getRequestPath());
    }
