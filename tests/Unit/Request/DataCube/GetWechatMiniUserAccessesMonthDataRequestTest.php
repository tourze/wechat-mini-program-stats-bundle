...
class GetWechatMiniUserAccessesMonthDataRequestTest extends TestCase
{
    ...
    {
        $this->assertSame('/datacube/getweanalysisappidmonthlyretaininfo', $this->request->getRequestPath());
    }
